...
use App\Filament\App\Resources\CommunionResource\Pages;
use App\Filament\App\Resources\CommunionResource\RelationManagers;
...
class CommunionResource extends Resource
{
    protected static ?string $model = Communion::class;

    protected static ?string $navigationIcon = 'heroicon-o-sun';
    protected static ?string $navigationGroup = 'Sacrament Management';
    protected static ?string $navigationLabel = 'Communion';
    protected static ?string $modelLabel = 'Communion';

    protected static ?int $navigationSort = 2;
    protected static ?string $recordTitleAttribute = 'cplace';
        ...
        return $form
            ->schema([
               ...
               ->searchable()
                ...
                ->native(false)
                    ->required(),
                Forms\Components\TextInput::make('cplace')
                    ->required()
                    ->label('Place')
                    ->maxLength(255),
                    Forms\Components\Select::make('person_id')
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('cdate')
                    ...
                    ->date('d/m/Y')
                    ->sortable(),
                Tables\Columns\TextColumn::make('cplace')
                ->label('Place')
                ->sortable()
                    ->searchable(),
            ...
            ->actions([
                ...
                ->url(fn (Communion $record)=>route('communion.pdf', $record))
                ->openUrlInNewTab(),
    ...
    public static function Infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ...
            ->schema([
                Section::make('Communion Details')
                    ->columns([
                        'sm' => 3,
                        'xl' => 6,
                        '2xl' => 8,
                    ...
                    ->schema([
                        ...
                        TextEntry::make('cdate')->label('Date'),
                        TextEntry::make('cplace')->label('Place'),
    ...
    {
        return [
            'index' => Pages\ListCommunions::route('/'),
            'create' => Pages\CreateCommunion::route('/create'),
            //'view' => Pages\ViewCommunion::route('/{record}'),
            'edit' => Pages\EditCommunion::route('/{record}/edit'),
        ];
    }
}
